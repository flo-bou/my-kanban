            ...
            <div className="vignetteModalChecklist container-fluid my-4">
                ...
                <div className={hideWhenClEmpty} id={'Checklist' + this.props.vignetteID}>
                    ...
                    <div className="row my-3">
                        <div className="col">
                            <button type="button" className='btn btn-sm btn-outline-secondary border-0' onClick={ () => {this.addChecklistItemToState()} }>
                                Add a task
                            </button>
                        </div>
                        <div className="col text-end">
                            <button type="button" className='btn btn-sm btn-outline-danger me-0 ms-auto border-0' onClick={ () => {this.deleteChecklist()} }>
                                Delete
                            </button>
                        </div>
                    </div>
